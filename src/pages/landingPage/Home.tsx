          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16">
              <button
                ...
                className="bg-odara-accent border-2 border-odara-contorno hover:bg-odara-secondary/90 text-odara-contorno font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg text-sm sm:text-base"
              >
                Explorar Funcionalidades
              </button>
              <button
                onClick={() => scrollToSection("contato")}
                className="border-2 border-odara-contorno text-odara-contorno hover:bg-white hover:text-odara-primary font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
              >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-center mt-8 sm:mt-12 px-4">
              <button
                ...
                className="bg-odara-accent border-2 border-odara-contorno hover:bg-odara-secondary/90 text-odara-contorno font-bold py-3 px-6 sm:px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg text-sm sm:text-base w-full sm:w-auto min-w-[240px]"
              >
            ...
            <div className="space-y-8 sm:space-y-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                ...
                <div className="space-y-3">
                  <h3 className="text-xl sm:text-2xl font-bold text-odara-accent">Nossa Missão</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                <div className="space-y-3 lg:order-1 order-2">
                  <h3 className="text-xl sm:text-2xl font-bold text-odara-accent">Nossa Visão</h3>
                  <div className="space-y-2 text-odara-dark leading-relaxed text-sm sm:text-base">
                    <p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                ...
                <div className="space-y-3">
                  <h3 className="text-xl sm:text-2xl font-bold text-odara-accent">Nossos Valores</h3>
                  <div className="space-y-2 text-odara-dark leading-relaxed text-sm sm:text-base">
                    <p>
          ...
          <div className="space-y-8 sm:space-y-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-6 lg:space-x-8 text-odara-white/80 text-sm sm:text-base">
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-odara-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
